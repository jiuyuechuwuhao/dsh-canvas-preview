 ...
 * between the dynamic runtime (host.call) and static package wiring.
 */
...
function rpc(method, args) {
  ...
  // Static packages: route to the installed-package remote surface here.
}
...
function CanvasView(props) {
  ...
  function onExport(fmt) {
    ...
    rpc('canvas/export', { path: state.picked, format: fmt, w: 1600, h: 1200 }).then(function (res) {
      const ok = res !== null && res !== undefined && typeof res === 'object'
...
export const name = 'dsh-canvas-preview/client'
